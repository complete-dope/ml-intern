...
export const GEMINI_MODEL_PATH = 'gemini/gemini-3.1-flash-lite-preview';
...
export function isPremiumPath(modelPath: string | undefined): boolean {
  return modelPath === CLAUDE_MODEL_PATH || modelPath === GPT_55_MODEL_PATH || modelPath === GEMINI_MODEL_PATH;
}
